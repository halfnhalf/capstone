...
class DemoScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.rams = Image(source='vcu.png', size_hint = (0.25,0.25),pos = (230,350))
        ...
        vcu = Label(text = 'VCU',color = (1,.8,0,1), font_size = 60,pos = (60,170))
        debug = Button(text = 'Debug', size_hint=(.15, .15),background_color = (1,0,0,0.8),font_size = 20,pos = (20,20))
        go_to_hearing_button= Button(text = 'Take your test!',size_hint=(.5, .2),background_color = (0,1,0,2),font_size = 20,pos = (205,240))
        go_to_hearing_button.bind(on_press=self.go_to_instruction)

        result1= Button(text = 'Result 1',size_hint=(.15, .05),background_color = (0,1,0,1),font_size = 15,pos = (340,180))
        result1.bind(on_press=self.go_to_results_1)

        result2= Button(text = 'Result 2',size_hint=(.15, .05),background_color = (0,1,0,1),font_size = 15,pos = (340,140))
